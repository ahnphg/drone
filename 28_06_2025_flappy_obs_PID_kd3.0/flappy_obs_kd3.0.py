...
- Model trước tỉ lệ thất bại do nguy hiểm nhiều => Model này PID tăng kd từ 2.0 lên 3.0

- python flappy_obs_kd3.0.py --mode <train|visualize> --distance 100
...
# ================================= MÔ HÌNH DRONE =================================
class ImprovedDrone:
    def __init__(self, target_z=5.0, kp=5.0, ki=0.05, kd=3.0):  # Tăng kp từ 3.0 lên 5.0
        self.mass = 1.0
        self.I = 0.2
        self.kd = 0.02
        self.g = 9.81
